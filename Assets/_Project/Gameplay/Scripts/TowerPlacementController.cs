...
namespace FG_GP2_T3
{
    public class TowerPlacementController : MonoBehaviour
    {
        ...
        void ConfirmPlacement()
        {
            ...
            previewTowerBase.PreviewOutlinable.enabled = false;
        ...
        public void SetSelectedTower(TowerData tower)
        {
            ...
            validCellsForSelectedTower = validCellsForSelectedTower.Where(cell =>
            { //Filtering out towers that have already fused
        ...
        public void PreviewTowerOnEmptyCell()
        {
            ...
            previewTowerBase.PreviewOutlinable.enabled = true;
