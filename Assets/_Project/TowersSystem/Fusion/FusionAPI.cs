...
namespace FG_GP2_T3
{
    ...
    public static class FusionAPI
    {
        ...
        public static bool CanFuse(TowerBase basetower, TowerData sacrificetowerData)
        {
            return FusionRegistry.CanFuse(basetower.Data.FusionID, sacrificetowerData.FusionID);
        }
